...
static void lcd_move_menu_axis()
{
    ...
    MENU_ITEM(submenu, "Deplacer X", lcd_move_x);
    MENU_ITEM(submenu, "Deplacer Y", lcd_move_y);
    if (move_menu_scale < 10.0)
    {
        MENU_ITEM(submenu, "Deplacer Z", lcd_move_z);
        MENU_ITEM(submenu, "Extrudeur", lcd_move_e);
    }
    END_MENU();
}
...
static void lcd_move_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_PREPARE, lcd_prepare_menu);
    MENU_ITEM(submenu, "Deplacer 10mm", lcd_move_menu_10mm);
    MENU_ITEM(submenu, "Deplacer 1mm", lcd_move_menu_1mm);
    MENU_ITEM(submenu, "Deplacer 0.1mm", lcd_move_menu_01mm);
    END_MENU();
}
